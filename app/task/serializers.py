...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ['id', 'user', 'title', 'description', 'category', 'assignees', 'subtasks', 'due_date', 'priority', 'created_at', 'updated_at', 'list']
    ...
    def to_representation(self, instance):
        ...
        self.fields['list'] = ListSerializer(read_only=True)
    ...
    def to_internal_value(self, data):
        ...
        self.fields['list'] = serializers.PrimaryKeyRelatedField(queryset=List.objects.all())
