...
if TYPE_CHECKING:
    PhoneNumberCharFiled = models.CharField[str, str]
else:
    PhoneNumberCharFiled = models.CharField

class PhoneNumberField(PhoneNumberCharFiled):
    ...
    def formfield(
        self, form_class=..., choices_form_class=..., **kwargs
    ) -> Optional[Field]: ...
